...
all: bin bios
	...
	$(CC) $(CFLAGS) -o cbm2basic cbm2basic.c fake6502.o -D FAST
	$(CC) $(CFLAGS) -o microtanbasic microtanbasic.c fake6502.o -D FAST
...
bin:
	...
	bin2c -i ./msbasic/cbmbasic2.bin -o ./msbasic/cbm2_msbasic.h -l 40 -a msbasic_bin
	bin2c -i ./msbasic/microtan.bin -o ./msbasic/microtan_msbasic.h -l 40 -a msbasic_bin

bios:
	make -C ./bios all

clean:
	rm -f *.o kim1basic ./msbasic/kb9_msbasic.h osibasic ./msbasic/osi_msbasic.h cbm2basic ./msbasic/cbm2_msbasic.h microtanbasic ./msbasic/microtan_msbasic.h
	make -C ./bios clean
